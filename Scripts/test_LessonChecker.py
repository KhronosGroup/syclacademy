...
test_cases = [
    ...
    },
    {
        ...
        "body": '<pre><code class="language-cpp" data-noescape><mark>message</mark></code><pre>',
        "extract": False,
        "verify": True,
        "fix": False,
        "silent": True,
    ...
    },
    {
        ...
        "body": '<pre><code class="language-cpp">int main() { return 0; }</code></pre>',
        "extract": True,
        "verify": False,
        "fix": False,
        "silent": True,
    ...
    },
    {
        ...
        "body": '<pre><code class="language-cpp">&</code></pre>',
        "extract": False,
        "verify": False,
        "fix": True,
        "silent": False,
